...
import heroImg from "@/assets/miloan-hero.jpg";
    ...
    <main>
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroImg} alt="Young professional in PNG" className="w-full h-full object-cover" />
        ...
        <div className="relative container mx-auto px-4 lg:px-8 pt-32 pb-20 lg:pt-40 lg:pb-28">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="max-w-2xl">
            <span className="inline-block px-4 py-1.5 bg-gold/20 text-gold rounded-full text-sm font-semibold mb-4">MiLoan</span>
            <h1 className="text-4xl lg:text-5xl font-bold font-heading text-white mb-6 leading-tight">
              Quick Personal <span className="text-gold">Loans</span> When You Need Them Most
            </h1>
            <p className="text-lg text-white/80 mb-8">
              Life doesn't wait — and neither should you. MiLoan offers fast, affordable personal loans to help you cover expenses, emergencies, or personal goals.
            </p>
